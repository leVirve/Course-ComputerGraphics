...
void setLightingSource()
{
    ...
    world.lights[0].constantAttenuation = 0.79f;
    world.lights[0].spotExponent = 1;
    world.lights[0].spotCutoff = 180;
    ...
    world.lights[1].linearAttenuation = 0.045f;
    world.lights[1].quadraticAttenuation = 0.0075f;
    world.lights[1].spotCutoff = 180;
    ...
    world.lights[2].constantAttenuation = 0.1f;
    world.lights[2].linearAttenuation = 0.003f;
    world.lights[2].quadraticAttenuation = 0.005f;
